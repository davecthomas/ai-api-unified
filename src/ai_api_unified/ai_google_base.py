            ...
            *,
            ...
            def _retry_later(
                ...
                *,
                ...
                sleep_seconds: float = base_delay + (
                    jitter_fraction * effective_max_jitter
                )
            ...
            while True:
                ...
                except gerr.ServerError as gemini_server_error:  # type: ignore[attr-defined]
                    _retry_later(
                        gemini_server_error,
                ...
                except gerr.ClientError as gemini_error:  # type: ignore[attr-defined]
                ...
                except gerr.APIError as gemini_api_error:  # type: ignore[attr-defined]
